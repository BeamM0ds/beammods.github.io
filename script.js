...
async function loadMods() {
    try {
        ...
        document.getElementById('mods').innerHTML = "<p style='color:red;'>Error loading mods.json</p>";
    }
}
    ...
    mods.forEach((mod) => {
        ...
        card.innerHTML = `
            ...
            <div style="padding:20px;">
                ...
                <p style="color:#3498db; font-size:12px; font-weight:600; margin:6px 0; font-family:sans-serif;">by ${mod.author || 'Royal Renderings'}</p>
                <p style="color:#888; font-size:13px; margin-bottom:15px; line-height:1.4; font-family:sans-serif;">${mod.description.substring(0, 65)}...</p>
                
                <div style="display:block; text-align:center; background:#3498db; color:white; padding:12px; border-radius:10px; text-decoration:none; font-weight:700; font-size:14px; font-family:sans-serif;">
                    View Mod
                </div>
            </div>`;
