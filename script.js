...
async function loadMods() {
    try {
        ...
        document.getElementById('mods').innerHTML = "<p style='color:red; padding: 20px;'>Error: Check your mods.json formatting!</p>";
    }
}
...
function renderMods(mods) {
    ...
    if (mods.length === 0) {
        container.innerHTML = "<p style='color:#555; padding: 20px;'>No mods found in this category.</p>";
        return;
    }
    ...
    mods.forEach((mod) => {
        ...
        card.innerHTML = `
            ...
            <div class="card-info">
                <h2 style="margin:0; font-size:18px; letter-spacing:-0.5px;">${mod.name}</h2>
