...
function renderMods(mods) {
    ...
    if (mods.length === 0) {
        container.innerHTML = `<p style="color:#8b949e; padding:20px;">No mods match your search.</p>`;
        return;
    }
    ...
    mods.forEach((mod) => {
        ...
        card.innerHTML = `
            <div style="position:relative; aspect-ratio:16/9; overflow:hidden;">
                <img src="${mod.image}" style="width:100%; height:100%; object-fit:cover;" onerror="this.src='https://via.placeholder.com/400x225'">
